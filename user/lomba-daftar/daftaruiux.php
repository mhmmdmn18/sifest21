...
<head>
	<title>Daftar UI/UX Design</title>
</head>
...
<body>
	...
	$sql = "INSERT INTO lombadaftar VALUES ('','$id','uiux',NULL,'','','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0)";
	$result = mysqli_query($koneksi, $sql);
	if ($result) {
		$querylomba = "SELECT * FROM lombadaftar WHERE id_user = $id AND lomba = 'uiux'";
		$resultlomba = mysqli_query($koneksi, $querylomba);
		$rowlomba = mysqli_fetch_assoc($resultlomba);
		$idlombadaftar = $rowlomba['id_lombadaftar'];
		$sql2 = "INSERT INTO uiux VALUES ('','$idlombadaftar','$namatim','','','','')";
