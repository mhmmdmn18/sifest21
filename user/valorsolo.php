...
$datalomba = mysqli_fetch_assoc(datalombavalorsolo($_GET));
if (!$datalomba) {
...
$query  = "SELECT * FROM valorsolo WHERE id_lombadaftar = $idlombadaftar";
...
<head>
    ...
    <title>Valorant (Solo) | SI FEST 2021</title>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                ...
                                if ($datalomba['verif'] == 1) {
                                    echo "<p class='text-subtitle text-muted'>Pengiriman Data Player</p>";
                                } 
                                else {
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Valorant (Solo)</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            ?>
                                            <form action="lomba-info/infovalorsolo.php" class="form form-vertical" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <h4 class="card-title mt-4">Pengiriman Data Player</h4>
                                                        <div class="col-12 col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <label for="id">Riot ID</label>
                                                                <input type="text" id="id"
                                                                    class="form-control mb-2" name="id"
                                                                    placeholder="Riot ID" value="<?= $row['id'] ?>" required>
                                                                <label for="nick">Tag</label>
                                                                <input type="text" id="nick"
                                                                    class="form-control mb-2" name="nick"
                                                                    placeholder="Tag" value="<?= $row['nick'] ?>" required>
                                                                <label for="pangkat">Pangkat</label>
                                                                <input type="text" id="pangkat"
                                                                    class="form-control mb-2" name="pangkat"
                                                                    placeholder="Pangkat" value="<?= $row['pangkat'] ?>" required>
                                            ...
                                            ?>
                                            <form action="lomba-verif/verifvalorsolo.php" class="form form-vertical" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <span class="mt-3">Pembayaran <b>Rp15K</b> ke:</span>
