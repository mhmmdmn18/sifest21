...
$datalomba = mysqli_fetch_assoc(datalombaposter($_GET));
if (!$datalomba) {
...
$query  = "SELECT * FROM poster WHERE id_lombadaftar = $idlombadaftar";
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            ?>
                                            <form action="lomba-info/infoposter.php" class="form form-vertical" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <h4 class="card-title mt-4">Pengiriman Karya</h4>
                                                        <div class="col-12 col-md-12 mb-3">
                                                            <div class="form-group">
                                                                <label for="bukti">Upload file poster (Max Size 10MB)</label>
                                                                ...
                                                                <a href="filePoster/<?= $file ?>"><?php echo $file ?></a>
                                                                <p style="font-size: small;">
                                                                    <i>File word <b>(.doc/.docx)</b> dengan format nama file</i> 'JudulPoster_NamaLengkap_AsalInstansi'
                                                                </p>
                                            ...
                                            ?>
                                            <form action="lomba-verif/verifposter.php" class="form form-vertical" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <span class="mt-3">Pembayaran <b>Rp35K</b> ke:</span>
                                            ...
                                            <span><i class="bi bi-whatsapp"></i><a href="https://wa.me/6285384925563" target="_blank"> +62 853-8492-5563</a> (Amanda)</span><br>
