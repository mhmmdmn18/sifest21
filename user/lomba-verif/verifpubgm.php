...
<body>
    ...
    if (isset($_POST["submit"])) {
        ...
        $query = "UPDATE lombadaftar SET 
                bukti='$bukti',ktm1='$ktm1',ktm2='$ktm2',ktm3='$ktm3',ktm4='$ktm4'                
                WHERE id_user = '$id' AND lomba='pubgm'";
        $hasil = mysqli_query($koneksi, $query);
        if ($hasil) {
            $query = "UPDATE pubgm SET 
                    nama1='$nama1',nama2='$nama2',nama3='$nama3',nama4='$nama4'
