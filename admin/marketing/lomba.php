...
<head>
    ...
    <title>Lomba | Admin Marketing SI FEST 2021</title>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    $user = mysqli_query($koneksi, "SELECT * from user inner join lombadaftar on user.id_user = lombadaftar.id_user where verif=1 ");
                                    $no = 1;
                                    foreach ($user as $row) {
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row['lomba'] ?></td>
                                            <td><a href="https://instagram.com/<?= $row['referral'] ?>" target="_blank"><?= $row['referral'] ?></a></td>
                                        </tr>
                                    <?php
                                        $no++;
                                    }
