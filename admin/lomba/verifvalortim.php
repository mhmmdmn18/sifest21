...
<head>
    ...
    <title>Verifikasi Valorant (Tim) | Admin Lomba SI FEST 2021</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Verifikasi Valorant (Tim)</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * from valortim inner join lombadaftar on valortim.id_lombadaftar = lombadaftar.id_lombadaftar inner join user on lombadaftar.id_user = user.id_user WHERE lomba='valortim' ");
                                    $no = 1;
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myModalLabel1">Verifikasi Valorant (Tim)</h5>
