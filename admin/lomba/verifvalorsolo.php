...
<head>
    ...
    <title>Verifikasi Valorant (Solo) | Admin Lomba SI FEST 2021</title>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Verifikasi Valorant (Solo)</h3>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Verifikasi Valorant (Solo)</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * from lombadaftar inner join user on lombadaftar.id_user = user.id_user WHERE lomba='valorsolo' ");
                                    $no = 1;
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myModalLabel1">Verifikasi Valorant (Solo)</h5>
