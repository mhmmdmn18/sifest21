...
<head>
    ...
    <title>Verifikasi Artikel | Admin Lomba SI FEST 2021</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Verifikasi Artikel</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * from lombadaftar inner join user on lombadaftar.id_user = user.id_user WHERE lomba='artikel' ");
                                    $no = 1;
