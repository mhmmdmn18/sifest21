...
<head>
    ...
    <title>Valorant (Tim) | Admin Lomba SI FEST 2021</title>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * from lombadaftar inner join user on lombadaftar.id_user = user.id_user inner join valortim on lombadaftar.id_lombadaftar = valortim.id_lombadaftar WHERE verif=1 ");
                                    $no = 1;
