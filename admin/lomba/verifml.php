...
<head>
    ...
    <title>Verifikasi ML | Admin Lomba SI FEST 2021</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Verifikasi ML</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * from ml inner join lombadaftar on ml.id_lombadaftar = lombadaftar.id_lombadaftar inner join user on lombadaftar.id_user = user.id_user WHERE lomba='ml' ");
                                    $no = 1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="../../user/fileKTM/<?php echo $data['sel1']; ?>" target="_blank"><img src="../../user/fileKTM/<?php echo $data['sel1']; ?>" width="50" height="50"></a></td>

                                            <td><?= $data['nama2']  ?></td>
                                            <td><?= $data['nim2']  ?></td>
                                            <td><a href="../../user/fileKTM/<?php echo $data['ktm2']; ?>" target="_blank"><img src="../../user/fileKTM/<?php echo $data['ktm2']; ?>" width="50" height="50"></a></td>
                                            <td><a href="../../user/fileKTM/<?php echo $data['sel2']; ?>" target="_blank"><img src="../../user/fileKTM/<?php echo $data['sel2']; ?>" width="50" height="50"></a></td>

                                            <td><?= $data['nama3']  ?></td>
                                            <td><?= $data['nim3']  ?></td>
                                            <td><a href="../../user/fileKTM/<?php echo $data['ktm3']; ?>" target="_blank"><img src="../../user/fileKTM/<?php echo $data['ktm3']; ?>" width="50" height="50"></a></td>
                                            <td><a href="../../user/fileKTM/<?php echo $data['sel3']; ?>" target="_blank"><img src="../../user/fileKTM/<?php echo $data['sel3']; ?>" width="50" height="50"></a></td>

                                            <td><?= $data['nama4']  ?></td>
                                            <td><?= $data['nim4']  ?></td>
                                            <td><a href="../../user/fileKTM/<?php echo $data['ktm4']; ?>" target="_blank"><img src="../../user/fileKTM/<?php echo $data['ktm4']; ?>" width="50" height="50"></a></td>
                                            <td><a href="../../user/fileKTM/<?php echo $data['sel4']; ?>" target="_blank"><img src="../../user/fileKTM/<?php echo $data['sel4']; ?>" width="50" height="50"></a></td>

                                            <td><?= $data['nama5']  ?></td>
                                            <td><?= $data['nim5']  ?></td>
                                            <td><a href="../../user/fileKTM/<?php echo $data['ktm5']; ?>" target="_blank"><img src="../../user/fileKTM/<?php echo $data['ktm5']; ?>" width="50" height="50"></a></td>
                                            <td><a href="../../user/fileKTM/<?php echo $data['sel5']; ?>" target="_blank"><img src="../../user/fileKTM/<?php echo $data['sel5']; ?>" width="50" height="50"></a></td>
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myModalLabel1">Verifikasi ML</h5>
