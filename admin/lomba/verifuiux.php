...
<head>
    ...
    <title>Verifikasi UI/UX | Admin Lomba SI FEST 2021</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Verifikasi UI/UX</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * from uiux inner join lombadaftar on uiux.id_lombadaftar = lombadaftar.id_lombadaftar inner join user on lombadaftar.id_user = user.id_user WHERE lomba='uiux' ");
                                    $no = 1;
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myModalLabel1">Verifikasi UI/UX</h5>
