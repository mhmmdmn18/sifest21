...
<html lang="en">
<head>
  <title>Reset Password | SI FEST 2021</title>
  <meta charset="UTF-8">
  ...
  <div class="limiter">
    <div class="container-login100" style="background-image: url('assets/img/background/loreg-bg.jpg');">
      <div class="wrap-login100">
        <form action="resetpass.php" class="login100-form validate-form" method="get">
         ...
         <div class="contact100-form-checkbox cb-down">
            <input class="input-checkbox100" id="ckb1" type="checkbox" name="validate" required>
            <label class="label-checkbox100 fas" for="ckb1">
              Masukkan email akun yang akan direset passwordnya dengan benar! Form otomatis akan memproses pesan ke WhatsApp admin kemudian kirim pesan. Tunggu proses verifikasi dan password akan direset.
            </label>
          </div>
